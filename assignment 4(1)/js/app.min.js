                ...
                return function() {
                    ...
                    n.prototype.init = function() {
                        ...
                        if (this.settings.pager) {
                            ...
                            var n = this.core.outer.find(".lg-pager-outer");
                            n.html(this.getPagerHtml(this.core.galleryItems)),
                            n.first().on("click.lg touchend.lg", (function(t) {
                                var s = e.$LG(t.target);
                                if (s.hasAttribute("data-lg-item-id")) {
                                    var i = parseInt(s.attr("data-lg-item-id"));
                                    e.core.slide(i, !1, !0, !1)
                                }
                            }
                            )),
                            n.first().on("mouseover.lg", (function() {
                                clearTimeout(i),
                                n.addClass("lg-pager-hover")
                            }
                            )),
                            n.first().on("mouseout.lg", (function() {
                            ...
                            this.core.LGel.on(s + ".pager", (function(t) {
                                var s = t.detail.index;
                                e.manageActiveClass.call(e, s)
                            }
                            )),
                            this.core.LGel.on(t + ".pager", (function() {
                                n.empty(),
                                n.html(e.getPagerHtml(e.core.galleryItems)),
                    ...
                    ,
                    n.prototype.manageActiveClass = function(e) {
                ...
                return function() {
                    ...
                    r.prototype.build = function() {
                        ...
                        this.$lgThumb.first().on("click.lg touchend.lg", (function(t) {
                            var s = e.$LG(t.target);
                            s.hasAttribute("data-lg-item-id") && setTimeout((function() {
                    ...
                    r.prototype.enableThumbDrag = function() {
                        ...
                        this.$LG(window).on("mousemove.lg.thumb.global" + this.core.lgId, (function(i) {
                            e.core.lgOpened && s && (t.cords.endX = i.pageX,
                    ...
                    r.prototype.onThumbTouchEnd = function(e) {
                        ...
                        s *= i,
                        this.translateX = this.getPossibleTransformX(this.translateX - s),
                    ...
                    r.prototype.getThumbHtml = function(e, t) {
                        var s, i = this.core.galleryItems[t].__slideVideoInfo || {};
                        return s = i.youtube && this.settings.loadYouTubeThumbnail ? "//img.youtube.com/vi/" + i.youtube[1] + "/" + this.settings.youTubeThumbSize + ".jpg" : e,
 ...
 */
            e.exports = function() {
                ...
                return function() {
                    ...
                    return u.prototype.buildTemplates = function() {
                    ...
                    u.prototype.enableZoom = function(e) {
                        ...
                        this.$LG("body").first().hasClass("lg-from-hash") && e.detail.delay ? s = 0 : this.$LG("body").first().removeClass("lg-from-hash"),
                    ...
                    ,
                    u.prototype.getDragCords = function(e) {
                        return {
                            x: e.pageX,
                            y: e.pageY
                        }
                    ...
                    ,
                    u.prototype.getSwipeCords = function(e) {
                        return {
                            x: e.touches[0].pageX,
                            y: e.touches[0].pageY
                        }
                    ...
                    u.prototype.getDragAllowedAxises = function(e, t) {
                        var s = this.core.getSlideItem(this.core.index).find(".lg-image").first().get()
                          , i = 0
                          , n = 0
                          , o = s.getBoundingClientRect();
                        e ? (i = s.offsetHeight * e,
                        n = s.offsetWidth * e) : t ? (i = o.height + t * o.height,
                        n = o.width + t * o.width) : (i = o.height,
                        n = o.width);
                    ...
                    ,
                    u.prototype.zoomImage = function(e, t, s, i) {
                        if (!(Math.abs(t) <= 0)) {
                            var n, o, r = this.containerRect.width / 2 + this.containerRect.left, l = this.containerRect.height / 2 + this.containerRect.top + this.scrollTop;
                            ...
                            var u, h, p = this.getPossibleSwipeDragCords(t), g = r - this.pageX, m = l - this.pageY;
                            if (e - t > 1) {
                                var f = (e - t) / Math.abs(t);
                                u = (g = (t < 0 ? -g : g) + this.left * (f + (t < 0 ? -1 : 1))) / f,
                                h = (m = (t < 0 ? -m : m) + this.top * (f + (t < 0 ? -1 : 1))) / f
                            } else
                                u = g * (f = (e - t) * t),
                                h = m * f;
                            s && (c ? this.isBeyondPossibleLeft(u, p.minX) ? u = p.minX : this.isBeyondPossibleRight(u, p.maxX) && (u = p.maxX) : e > 1 && (u < p.minX ? u = p.minX : u > p.maxX && (u = p.maxX)),
                            d ? this.isBeyondPossibleTop(h, p.minY) ? h = p.minY : this.isBeyondPossibleBottom(h, p.maxY) && (h = p.maxY) : e > 1 && (h < p.minY ? h = p.minY : h > p.maxY && (h = p.maxY))),
                            this.setZoomStyles({
                                x: u,
                                y: h,
                                scale: e
                            ...
                            this.left = u,
                            this.top = h,
                            i && e >= this.getCurrentImageActualSizeScale() && this.setZoomImageSize()
                        }
                    }
                    ,
                    u.prototype.resetImageTranslate = function() {
                        var e = this.core.getSlideItem(this.core.index).find(".lg-image").first();
                        this.imageReset = !1,
                        e.removeClass("reset-transition reset-transition-y reset-transition-x"),
                    ...
                    ,
                    u.prototype.setZoomImageSize = function() {
                        var e = this
                        ...
                        setTimeout((function() {
                            ...
                            s.allowX && s.allowY ? t.addClass("reset-transition") : s.allowX && !s.allowY ? t.addClass("reset-transition-x") : !s.allowX && s.allowY && t.addClass("reset-transition-y")
                        }
                        ), 550)
                    }
                    ,
                    u.prototype.setZoomStyles = function(e) {
                        var t = this.core.getSlideItem(this.core.index).find(".lg-img-wrap").first()
                          , s = this.core.getSlideItem(this.core.index).find(".lg-image").first()
                    ...
                    u.prototype.setActualSize = function(e, t) {
                        ...
                        setTimeout((function() {
                            if (i.src && !s.core.outer.hasClass("lg-first-slide-loading")) {
                                var e = s.getCurrentImageActualSizeScale()
                                  , n = s.scale;
                                s.core.outer.hasClass("lg-zoomed") ? s.scale = 1 : s.scale = s.getScale(e),
                                s.setPageCords(t),
                                s.beginZoom(s.scale),
                    ...
                    ,
                    u.prototype.manageActualPixelClassNames = function() {
                    ...
                    u.prototype.init = function() {
                        ...
                        if (this.settings.zoom) {
                            ...
                            this.core.outer.on("touchstart.lg", (function(s) {
                                var i = e.$LG(s.target);
                                1 === s.touches.length && i.hasClass("lg-image") && (t ? (clearTimeout(t),
                                t = null,
                                s.preventDefault(),
                                e.setActualSize(e.core.index, s)) : t = setTimeout((function() {
                                    t = null
                                }
                                ), 300))
                            }
                            )),
                            this.core.LGel.on(s + ".zoom " + a + ".zoom " + l + ".zoom " + d + ".zoom " + c + ".zoom", (function() {
                            ...
                            this.core.getElementById("lg-zoom-out").on("click.lg", (function() {
                                if (e.isImageSlide()) {
                                    var t = 0;
                                    e.imageReset && (e.resetImageTranslate(),
                                    t = 50),
                                    setTimeout((function() {
                    ...
                    u.prototype.resetZoom = function(e) {
                        ...
                        var t = this.core.getElementById("lg-actual-size")
                          , s = this.core.getSlideItem(void 0 !== e ? e : this.core.index);
                    ...
                    u.prototype.pinchZoom = function() {
                        ...
                        this.core.outer.on("touchstart.lg", (function(s) {
                            if (o = e.core.getSlideItem(e.core.index),
                            e.isImageSlide() && 2 === s.touches.length) {
                                if (s.preventDefault(),
                        ...
                        this.core.$inner.on("touchmove.lg", (function(r) {
                            if (2 === r.touches.length && "pinch" === e.core.touchAction && (e.$LG(r.target).hasClass("lg-item") || o.get().contains(r.target))) {
                                r.preventDefault();
                                var l = e.getTouchDistance(r)
                                  , a = t - l;
                                if (!s && Math.abs(a) > 5 && (s = !0),
                                s) {
                                    n = e.scale;
                                    var d = Math.max(1, i + .02 * -a);
                        ...
                        this.core.$inner.on("touchend.lg", (function(i) {
                            if ("pinch" === e.core.touchAction && (e.$LG(i.target).hasClass("lg-item") || o.get().contains(i.target))) {
                                if (s = !1,
                                t = 0,
                                e.scale <= 1)
                                    e.resetZoom();
                    ...
                    ,
                    u.prototype.touchendZoom = function(e, t, s, i, n) {
                        var o = t.x - e.x
                          , r = t.y - e.y
                          , l = Math.abs(o) / n + 1
                          , a = Math.abs(r) / n + 1;
                        ...
                        (Math.abs(o) > 15 || Math.abs(r) > 15) && (i && (this.isBeyondPossibleTop(c.y, u.minY) ? c.y = u.minY : this.isBeyondPossibleBottom(c.y, u.maxY) && (c.y = u.maxY)),
                        s && (this.isBeyondPossibleLeft(c.x, u.minX) ? c.x = u.minX : this.isBeyondPossibleRight(c.x, u.maxX) && (c.x = u.maxX)),
                    ...
                    ,
                    u.prototype.getPossibleSwipeDragCords = function(e) {
                    ...
                    u.prototype.zoomSwipe = function() {
                        var e, t, s = this, i = {}, n = {}, o = !1, r = !1, l = !1, a = new Date, d = (new Date,
                        this.core.getSlideItem(this.core.index));
                        this.core.$inner.on("touchstart.lg", (function(n) {
                            if (s.isImageSlide() && (d = s.core.getSlideItem(s.core.index),
                            (s.$LG(n.target).hasClass("lg-item") || d.get().contains(n.target)) && 1 === n.touches.length && s.core.outer.hasClass("lg-zoomed"))) {
                                n.preventDefault(),
                                a = new Date,
                                s.core.touchAction = "zoomSwipe",
                                t = s.core.getSlideItem(s.core.index).find(".lg-img-wrap").first();
                        ...
                        this.core.$inner.on("touchmove.lg", (function(a) {
                            if (1 === a.touches.length && "zoomSwipe" === s.core.touchAction && (s.$LG(a.target).hasClass("lg-item") || d.get().contains(a.target))) {
                                a.preventDefault(),
                                s.core.touchAction = "zoomSwipe",
                                n = s.getSwipeCords(a);
                                var c = s.getZoomSwipeCords(i, n, r, l, e);
                                (Math.abs(n.x - i.x) > 15 || Math.abs(n.y - i.y) > 15) && (o = !0,
                                s.setZoomSwipeStyles(t, c))
                            }
                        }
                        )),
                        this.core.$inner.on("touchend.lg", (function(e) {
                            if ("zoomSwipe" === s.core.touchAction && (s.$LG(e.target).hasClass("lg-item") || d.get().contains(e.target))) {
                                if (e.preventDefault(),
                    ...
                    u.prototype.zoomDrag = function() {
                        var e, t, s, i, n = this, o = {}, r = {}, l = !1, a = !1, d = !1, c = !1;
                        this.core.outer.on("mousedown.lg.zoom", (function(t) {
                            if (n.isImageSlide()) {
                                var r = n.core.getSlideItem(n.core.index);
                                if (n.$LG(t.target).hasClass("lg-item") || r.get().contains(t.target)) {
                                    e = new Date,
                                    i = n.core.getSlideItem(n.core.index).find(".lg-img-wrap").first();
                                    var a = n.getDragAllowedAxises(0);
                                    c = a.allowY,
                                    d = a.allowX,
                                    n.core.outer.hasClass("lg-zoomed") && n.$LG(t.target).hasClass("lg-object") && (d || c) && (t.preventDefault(),
                                    o = n.getDragCords(t),
                        ...
                        this.$LG(window).on("mouseup.lg.zoom.global" + this.core.lgId, (function(s) {
                            if (l) {
                                if (t = new Date,
                                l = !1,
    ...
    (()=>{
        ...
        let a = (e,t=!1,s=500,i=0)=>{
            ...
            if (n) {
                ...
                if (t) {
                    ...
                    e.classList.contains("_header-scroll") ? a = e.offsetHeight : (e.style.cssText = "transition-duration: 0s;",
                ...
                if (document.documentElement.classList.contains("menu-open") && (o(),
            ...
            return function(...t) {
                if (void 0 === t[0]) {
                    for (let t = 0; t < this.length; t += 1)
                        y.indexOf(e) < 0 && (e in this[t] ? this[t][e]() : b(this[t]).trigger(e));
                    return this
                }
                return this.on(e, ...t)
            }
        ...
        const S = {
            ...
            off: function(...e) {
                ...
                for (let e = 0; e < o.length; e += 1) {
                    ...
                    for (let e = 0; e < this.length; e += 1) {
                        const o = this[e];
                        let r;
                        if (!s && o.dom7Listeners ? r = o.dom7Listeners[t] : s && o.dom7LiveListeners && (r = o.dom7LiveListeners[t]),
                        r && r.length)
                            for (let e = r.length - 1; e >= 0; e -= 1) {
                                const s = r[e];
                                i && s.listener === i || i && s.listener && s.listener.dom7proxy && s.listener.dom7proxy === i ? (o.removeEventListener(t, s.proxyListener, n),
                                r.splice(e, 1)) : i || (o.removeEventListener(t, s.proxyListener, n),
                                r.splice(e, 1))
                            }
                    }
                }
            ...
            parent: function(e) {
                const t = [];
                for (let s = 0; s < this.length; s += 1)
                    null !== this[s].parentNode && (e ? b(this[s].parentNode).is(e) && t.push(this[s].parentNode) : t.push(this[s].parentNode));
                return b(t)
            },
            parents: function(e) {
                const t = [];
        ...
        function E(e, t) {
            ...
            o = new s.WebKitCSSMatrix("none" === n ? "" : n)) : (o = r.MozTransform || r.OTransform || r.MsTransform || r.msTransform || r.transform || r.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"),
            i = o.toString().split(",")),
            ...
            for (let s = 1; s < arguments.length; s += 1) {
                ...
                if (null != i && !L(i)) {
                    ...
                    for (let t = 0, n = s.length; t < n; t += 1) {
                        ...
                        void 0 !== o && o.enumerable && (I(e[n]) && I(i[n]) ? i[n].__swiper__ ? e[n] = i[n] : z(e[n], i[n]) : !I(e[n]) && I(i[n]) ? (e[n] = {},
                        i[n].__swiper__ ? e[n] = i[n] : z(e[n], i[n])) : e[n] = i[n])
                    }
                }
            }
            return e
        ...
        function O(e) {
            ...
            const d = s > o ? "next" : "prev"
              ...
              , u = ()=>{
                r = (new Date).getTime(),
                null === l && (l = r);
                const e = Math.max(Math.min((r - l) / a, 1), 0)
        ...
        function D(e) {
            ...
            M || (M = function(e) {
                ...
                const u = o.match(/(iPod)(.*OS\s([\d_]+))?/)
                  ...
                  , p = "Win32" === n;
                let m = "MacIntel" === n;
                return !c && m && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x ${a}`) >= 0 && (c = o.match(/(Version)\/([\d.]+)/),
                c || (c = [0, 1, "13_0_0"]),
                m = !1),
                d && !p && (r.os = "android",
                r.android = !0),
        ...
        const _ = {
            ...
            updateSlides: function() {
                ...
                i.centeredSlides && i.cssMode && (P(e.wrapperEl, "--swiper-centered-offset-before", ""),
                ...
                for (let n = 0; n < u; n += 1) {
                    x = 0;
                    const r = c.eq(n);
                    if (T && e.grid.updateSlide(n, r, u, t),
                    "none" !== r.css("display")) {
                        ...
                        g.push(x),
                        i.centeredSlides ? (w = w + x / 2 + S / 2 + y,
                        0 === S && 0 !== n && (w = w - o / 2 - y),
                        0 === n && (w = w - o / 2 - y),
                        Math.abs(w) < .001 && (w = 0),
                ...
                if (e.virtualSize = Math.max(e.virtualSize, o) + f,
                ...
                i.centeredSlides && i.cssMode && !i.centeredSlidesBounds) {
                    ...
                    P(e.wrapperEl, "--swiper-centered-offset-after", e.size / 2 - g[g.length - 1] / 2 + "px");
            ...
            updateSlidesProgress: function(e) {
                ...
                for (let e = 0; e < i.length; e += 1) {
                    ...
                    const d = (r + (s.centeredSlides ? t.minTranslate() : 0) - a) / (l.swiperSlideSize + s.spaceBetween)
                      , c = (r - o[0] + (s.centeredSlides ? t.minTranslate() : 0) - a) / (l.swiperSlideSize + s.spaceBetween)
                      , u = -(r - a)
            ...
            updateSlidesClasses: function() {
                const e = this
                  , {slides: t, params: s, $wrapperEl: i, activeIndex: n, realIndex: o} = e
                  , r = e.virtual && s.virtual.enabled;
                let l;
                t.removeClass(`${s.slideActiveClass} ${s.slideNextClass} ${s.slidePrevClass} ${s.slideDuplicateActiveClass} ${s.slideDuplicateNextClass} ${s.slideDuplicatePrevClass}`),
                l = r ? e.$wrapperEl.find(`.${s.slideClass}[data-swiper-slide-index="${n}"]`) : t.eq(n),
                l.addClass(s.slideActiveClass),
                s.loop && (l.hasClass(s.slideDuplicateClass) ? i.children(`.${s.slideClass}:not(.${s.slideDuplicateClass})[data-swiper-slide-index="${o}"]`).addClass(s.slideDuplicateActiveClass) : i.children(`.${s.slideClass}.${s.slideDuplicateClass}[data-swiper-slide-index="${o}"]`).addClass(s.slideDuplicateActiveClass));
                let a = l.nextAll(`.${s.slideClass}`).eq(0).addClass(s.slideNextClass);
                s.loop && 0 === a.length && (a = t.eq(0),
                a.addClass(s.slideNextClass));
                let d = l.prevAll(`.${s.slideClass}`).eq(0).addClass(s.slidePrevClass);
                s.loop && 0 === d.length && (d = t.eq(-1),
                d.addClass(s.slidePrevClass)),
                s.loop && (a.hasClass(s.slideDuplicateClass) ? i.children(`.${s.slideClass}:not(.${s.slideDuplicateClass})[data-swiper-slide-index="${a.attr("data-swiper-slide-index")}"]`).addClass(s.slideDuplicateNextClass) : i.children(`.${s.slideClass}.${s.slideDuplicateClass}[data-swiper-slide-index="${a.attr("data-swiper-slide-index")}"]`).addClass(s.slideDuplicateNextClass),
            ...
            updateActiveIndex: function(e) {
                const t = this
                  ...
                  , {slidesGrid: i, snapGrid: n, params: o, activeIndex: r, realIndex: l, snapIndex: a} = t;
                let d, c = e;
                if (void 0 === c) {
                    for (let e = 0; e < i.length; e += 1)
            ...
            updateClickedSlide: function(e) {
                ...
                t.clickedSlide = i,
                t.virtual && t.params.virtual.enabled ? t.clickedIndex = parseInt(C(i).attr("data-swiper-slide-index"), 10) : t.clickedIndex = n,
        ...
        const F = {
            ...
            setTranslate: function(e, t) {
                const s = this
                  , {rtlTranslate: i, params: n, $wrapperEl: o, wrapperEl: r, progress: l} = s;
                let a, d = 0, c = 0;
                s.isHorizontal() ? d = i ? -e : e : c = e,
                n.roundLengths && (d = Math.floor(d),
                c = Math.floor(c)),
                n.cssMode ? r[s.isHorizontal() ? "scrollLeft" : "scrollTop"] = s.isHorizontal() ? -d : -c : n.virtualTranslate || o.transform(`translate3d(${d}px, ${c}px, 0px)`),
        ...
        function H(e) {
            ...
            let l = i;
            if (l || (l = o > r ? "next" : o < r ? "prev" : "reset"),
            t.emit(`transition ${n}`),
            s && o !== r) {
                if ("reset" === l)
        ...
        const X = {
            slideTo: function(e, t, s, i, n) {
                ...
                let r = e;
                r < 0 && (r = 0);
                const {params: l, snapGrid: a, slidesGrid: d, previousIndex: c, activeIndex: u, rtlTranslate: h, wrapperEl: p, enabled: g} = o;
                if (o.animating && l.preventInteractionOnTransition || !g && !i && !n)
                    return !1;
                const m = Math.min(o.params.slidesPerGroupSkip, r);
                let f = m + Math.floor((r - m) / o.params.slidesPerGroup);
                f >= a.length && (f = a.length - 1),
                (u || l.initialSlide || 0) === (c || 0) && s && o.emit("beforeSlideChangeStart");
                const v = -a[f];
                ...
                0 === t ? o.transitionEnd(s, b) : o.animating || (o.animating = !0,
            ...
            slideNext: function(e, t, s) {
                ...
                return r.rewind && i.isEnd ? i.slideTo(0, e, t, s) : i.slideTo(i.activeIndex + a, e, t, s)
            },
            slidePrev: function(e, t, s) {
                void 0 === e && (e = this.params.speed),
                void 0 === t && (t = !0);
                const i = this
                  , {params: n, animating: o, snapGrid: r, slidesGrid: l, rtlTranslate: a, enabled: d} = i;
                if (!d)
                    return i;
                if (n.loop) {
                ...
                const u = c(a ? i.translate : -i.translate)
                  , h = r.map((e=>c(e)));
        ...
        const N = {
            loopCreate: function() {
                ...
                "auto" !== s.slidesPerView || s.loopedSlides || (s.loopedSlides = o.length),
            ...
            loopFix: function() {
                ...
                const {activeIndex: t, slides: s, loopedSlides: i, allowSlidePrev: n, allowSlideNext: o, snapGrid: r, rtlTranslate: l} = e;
                let a;
                e.allowSlidePrev = !0,
                e.allowSlideNext = !0;
                ...
                if (t < i) {
                    a = s.length - 3 * i + t,
                    a += i;
                    e.slideTo(a, 0, !1, !0) && 0 !== d && e.setTranslate((l ? -e.translate : e.translate) - d)
        ...
        function q(e) {
            ...
            if ("wrapper" === o.touchEventsTarget && !d.closest(t.wrapperEl).length)
                return;
            if (n.isTouchEvent = "touchstart" === a.type,
            ...
            if (n.isTouched && n.isMoved)
                return;
            !!o.noSwipingClass && "" !== o.noSwipingClass && a.target && a.target.shadowRoot && e.path && e.path[0] && (d = C(e.path[0]));
            ...
            "touchstart" !== a.type) {
                ...
                "SELECT" === d[0].nodeName && (n.isTouched = !1)),
                s.activeElement && C(s.activeElement).is(n.focusableElements) && s.activeElement !== d[0] && s.activeElement.blur();
                const i = e && t.allowTouchMove && o.touchStartPreventDefault;
                !o.touchStartForcePreventDefault && !i || d[0].isContentEditable || a.preventDefault()
            }
        ...
        function W(e) {
            ...
            !i.isTouched)
                return void (i.startMoving && i.isScrolling && s.emit("touchMoveOpposite", a));
            if (i.isTouchEvent && "touchmove" !== a.type)
                return;
            const d = "touchmove" === a.type && a.targetTouches && (a.targetTouches[0] || a.changedTouches[0])
            ...
            if (a.preventedByNestedSwiper)
                ...
                void (o.startY = u);
            if (!s.allowTouchMove)
                return C(a.target).is(i.focusableElements) || (s.allowClick = !1),
            ...
            if (i.isTouchEvent && n.touchReleaseOnEdges && !n.loop)
                if (s.isVertical()) {
                    if (u < o.startY && s.translate <= s.maxTranslate() || u > o.startY && s.translate >= s.minTranslate())
                        return i.isTouched = !1,
                        void (i.isMoved = !1)
                } else if (c < o.startX && s.translate <= s.maxTranslate() || c > o.startX && s.translate >= s.minTranslate())
                    return;
            if (i.isTouchEvent && t.activeElement && a.target === t.activeElement && C(a.target).is(i.focusableElements))
                return i.isMoved = !0,
                void (s.allowClick = !1);
            if (i.allowTouchCallbacks && s.emit("touchMove", a),
            ...
            if (void 0 === i.isScrolling) {
                let e;
                s.isHorizontal() && o.currentY === o.startY || s.isVertical() && o.currentX === o.startX ? i.isScrolling = !1 : p * p + g * g >= 25 && (e = 180 * Math.atan2(Math.abs(g), Math.abs(p)) / Math.PI,
                i.isScrolling = s.isHorizontal() ? e > n.touchAngle : 90 - e > n.touchAngle)
            }
            if (i.isScrolling && s.emit("touchMoveOpposite", a),
            ...
            m > 0 && i.currentTranslate > s.minTranslate() ? (f = !1,
            n.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + m) ** v)) : m < 0 && i.currentTranslate < s.maxTranslate() && (f = !1,
            n.resistance && (i.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - m) ** v)),
        ...
        function V(e) {
            ...
            if (t.allowClick) {
                ...
                t.emit("tap click", a),
                c < 300 && d - s.lastClickTime < 300 && t.emit("doubleTap doubleClick", a)
            }
            if (s.lastClickTime = x(),
            T((()=>{
            ...
            s.isMoved = !1,
            s.startMoving = !1,
            u = i.followFinger ? o ? t.translate : -t.translate : -s.currentTranslate,
            i.cssMode)
                return;
            ...
            if (c > i.longSwipesMs) {
                ...
                "next" === t.swipeDirection && (f >= i.longSwipesRatio ? t.slideTo(i.rewind && t.isEnd ? g : h + v) : t.slideTo(h)),
                "prev" === t.swipeDirection && (f > 1 - i.longSwipesRatio ? t.slideTo(h + v) : null !== m && f < 0 && Math.abs(f) > i.longSwipesRatio ? t.slideTo(m) : t.slideTo(h))
            } else {
                if (!i.shortSwipes)
                    return void t.slideTo(t.activeIndex);
                t.navigation && (a.target === t.navigation.nextEl || a.target === t.navigation.prevEl) ? a.target === t.navigation.nextEl ? t.slideTo(h + v) : t.slideTo(h) : ("next" === t.swipeDirection && t.slideTo(null !== g ? g : h + v),
        ...
        const K = (e,t)=>{
            const s = h()
              , {params: i, touchEvents: n, el: o, wrapperEl: r, device: l, support: a} = e
              , d = !!i.nested
              , c = "on" === t ? "addEventListener" : "removeEventListener"
              , u = t;
            if (a.touch) {
                const t = !("touchstart" !== n.start || !a.passiveListener || !i.passiveListeners) && {
                    passive: !0,
                    capture: !1
                };
                o[c](n.start, e.onTouchStart, t),
                o[c](n.move, e.onTouchMove, a.passiveListener ? {
                    passive: !1,
                    capture: d
                } : d),
            ...
            (i.preventClicks || i.preventClicksPropagation) && o[c]("click", e.onClick, !0),
            i.cssMode && r[c]("scroll", e.onScroll),
            i.updateOnWindowResize ? e[u](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", R, !0) : e[u]("observerUpdate", R, !0)
        }
        ;
        const Q = {
            attachEvents: function() {
                ...
                e.onClick = j.bind(e),
                i.touch && !Z && (t.addEventListener("touchstart", U),
                Z = !0),
                K(e, "on")
            },
        ...
        const ee = {
            setBreakpoint: function() {
                const e = this
                  , {activeIndex: t, initialized: s, loopedSlides: i=0, params: n, $el: o} = e
                  , r = n.breakpoints;
                ...
                const a = (l in r ? r[l] : void 0) || e.originalParams
                  ...
                  , c = J(e, a)
                  , u = n.enabled;
                d && !c ? (o.removeClass(`${n.containerModifierClass}grid ${n.containerModifierClass}grid-column`),
                e.emitContainerClasses()) : !d && c && (o.addClass(`${n.containerModifierClass}grid`),
                (a.grid.fill && "column" === a.grid.fill || !a.grid.fill && "column" === n.grid.fill) && o.addClass(`${n.containerModifierClass}grid-column`),
            ...
            getBreakpoint: function(e, t, s) {
                ...
                for (let e = 0; e < r.length; e += 1) {
                    ...
                    "window" === t ? n.matchMedia(`(min-width: ${l}px)`).matches && (i = o) : l <= s.clientWidth && (i = o)
                }
                return i || "max"
            }
        };
        const te = {
            addClasses: function() {
                const e = this
                  , {classNames: t, params: s, rtl: i, $el: n, device: o, support: r} = e
                  , l = function(e, t) {
                    const s = [];
                    return e.forEach((e=>{
        ...
        const ne = {
            ...
            images: {
                loadImage: function(e, t, s, i, n, o) {
                    ...
                    C(e).parent("picture")[0] || e.complete && n ? a() : t ? (l = new r.Image,
                    l.onload = a,
                    l.onerror = a,
                    i && (l.sizes = i),
                    s && (l.srcset = s),
        ...
        class re {
            ...
            slidesPerViewDynamic(e, t) {
                void 0 === e && (e = "current"),
                void 0 === t && (t = !1);
                const {params: s, slides: i, slidesGrid: n, slidesSizesGrid: o, size: r, activeIndex: l} = this;
                let a = 1;
                if (s.centeredSlides) {
        ...
        function de(e) {
            ...
            i("click", ((e,s)=>{
                const {$nextEl: i, $prevEl: o} = t.navigation
                  , r = s.target;
                if (t.params.navigation.hideOnClick && !C(r).is(o) && !C(r).is(i)) {
                    if (t.pagination && t.params.pagination && t.params.pagination.clickable && (t.pagination.el === r || t.pagination.el.contains(r)))
                        return;
                    let e;
                    i ? e = i.hasClass(t.params.navigation.hiddenClass) : o && (e = o.hasClass(t.params.navigation.hiddenClass)),
        ...
        function ce(e) {
            ...
            function g() {
                ...
                s ? (c = -c,
                c > 0 ? (d = l - c,
                c = 0) : -c + l > a && (d = a + c)) : c < 0 ? (d = l + c,
                c = 0) : c + l > a && (d = a - c),
                t.isHorizontal() ? (n.transform(`translate3d(${c}px, 0, 0)`),
                n[0].style.width = `${d}px`) : (n.transform(`translate3d(0px, ${c}px, 0)`),
            ...
            function m() {
                ...
                s[0].style.width = "",
                s[0].style.height = "",
                a = t.isHorizontal() ? i[0].offsetWidth : i[0].offsetHeight,
                d = t.size / (t.virtualSize + t.params.slidesOffsetBefore - (t.params.centeredSlides ? t.snapGrid[0] : 0)),
                l = "auto" === t.params.scrollbar.dragSize ? a * d : parseInt(t.params.scrollbar.dragSize, 10),
            ...
            function v(e) {
                const {scrollbar: s, rtlTranslate: i} = t
                  , {$el: n} = s;
                let o;
                o = (f(e) - n.offset()[t.isHorizontal() ? "left" : "top"] - (null !== r ? r : l / 2)) / (a - l),
            ...
            function b(e) {
                const s = t.params.scrollbar
                  ...
                  , {$el: l, $dragEl: a} = i;
                c = !0,
                r = e.target === a[0] || e.target === a ? f(e) - e.target.getBoundingClientRect()[t.isHorizontal() ? "left" : "top"] : null,
                e.preventDefault(),
                e.stopPropagation(),
                o.transition(100),
                a.transition(100),
            ...
            function y(e) {
                const {scrollbar: s, $wrapperEl: i} = t
                  , {$el: o, $dragEl: r} = s;
                c && (e.preventDefault ? e.preventDefault() : e.returnValue = !1,
                v(e),
                i.transition(0),
                o.transition(0),
                r.transition(0),
            ...
            function S(e) {
                const {scrollbar: s, touchEventsTouch: i, touchEventsDesktop: n, params: r, support: l} = t
                  , a = s.$el;
                if (!a)
                    return;
                const d = a[0]
                  ...
                  , u = !(!l.passiveListener || !r.passiveListeners) && {
                    passive: !0,
                    capture: !1
                };
                if (!d)
                ...
                l.touch ? (d[h](i.start, b, c),
                d[h](i.move, y, c),
                d[h](i.end, w, u)) : (d[h](n.start, b, c),
                o[h](n.move, y, c),
                o[h](n.end, w, u))
            }
            function x() {
                ...
                if (!i.el)
                    return;
                let n = C(i.el);
                t.params.uniqueNavElements && "string" == typeof i.el && n.length > 1 && 1 === s.find(i.el).length && (n = s.find(i.el)),
                n.addClass(t.isHorizontal() ? i.horizontalClass : i.verticalClass);
                let o = n.find(`.${t.params.scrollbar.dragClass}`);
                0 === o.length && (o = C(`<div class="${t.params.scrollbar.dragClass}"></div>`),
                n.append(o)),
                Object.assign(e, {
                    $el: n,
                    el: n[0],
            ...
            i("init", (()=>{
                !1 === t.params.scrollbar.enabled ? I() : (x(),
                m(),
                g())
            }
            )),
        ...
        function pe(e, t) {
            const s = this
              , {$wrapperEl: i, params: n, activeIndex: o} = s;
            let r = o;
            n.loop && (r -= s.loopedSlides,
            s.loopDestroy(),
            ...
            n.loop && s.loopCreate(),
            n.observer || s.update(),
            n.loop ? s.slideTo(a + s.loopedSlides, 0, !1) : s.slideTo(a, 0, !1)
        }
        function ge(e) {
            const t = this
              , {params: s, $wrapperEl: i, activeIndex: n} = t;
        ...
        window.addEventListener("load", (function(e) {
            document.querySelector(".top-slider__slider") && new le(".top-slider__slider",{
                modules: [de, ce, fe],
                observer: !0,
                observeParents: !0,
                slidesPerView: 1.3,
            ...
            document.querySelector(".bottom-slider__slider") && new le(".bottom-slider__slider",{
                modules: [de, ce],
                observer: !0,
                observeParents: !0,
                slidesPerView: 1.3,
            ...
            document.querySelector(".trainers-slider__slider") && new le(".trainers-slider__slider",{
                modules: [de, ce],
                observer: !0,
                observeParents: !0,
                slidesPerView: 2.3,
            ...
            function() {
                let e = document.querySelectorAll(".body-subscriptions__slider-top")
                  , t = document.querySelectorAll(".body-subscriptions__slider-bottom");
                if (e.length > 0)
                    for (let t = 0; t < e.length; t++) {
                        const s = e[t]
                          , i = s.querySelector(".subscriptions-swiper-scrollbar");
                        new le(s,{
                            modules: [de, ce],
                            observer: !0,
                            observeParents: !0,
                ...
                if (t.length > 0)
                    for (let e = 0; e < t.length; e++) {
                        const s = t[e]
                          , i = s.querySelector(".subscriptions-swiper-scrollbar-bottom");
                        new le(s,{
                            modules: [de, ce],
                            observer: !0,
                            observeParents: !0,
